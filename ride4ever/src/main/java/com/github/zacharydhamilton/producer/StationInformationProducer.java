...
public class StationInformationProducer {
    private static final Logger logger = LogManager.getLogger(StationInformationProducer.class);
            ...
            while (true) {
                try {
                    ...
                    if (stationInformation != null) {
                        ...
                        producer.flush();
                        logger.info(String.format("Sending a bulk of '%s' stationInformation records", stationInformation.getData().getStations().size()));
                    }
